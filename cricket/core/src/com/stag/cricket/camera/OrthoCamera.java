package com.stag.cricket.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(MainCricket.WIDTH, MainCricket.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(MainCricket.WIDTH, MainCricket.HEIGHT);
